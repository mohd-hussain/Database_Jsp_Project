...
<body>
   ...
   <div class="main">
       <div class="grid-about">
            <p align="justify"><b>The Technical Discussion Forum(TDF) </b>is a discussion forum that gives information about various programming languages, general knowledge related questions, information related to Asp.net,Vb.net ,Java,Php,Os related questions,etc.</p>
       ...
       <div class="subbtn">
        <a href="contact.jsp" role="button" class="btn btn-primary">Contact Info...</a> 
       </div>
